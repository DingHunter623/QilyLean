...
(function(d,w){
  ...
  function buildIndustry(){
    return node(''
      ...
      +'<div class="qily-home-conversion-heading"><span class="qily-home-conversion-kicker">INDUSTRY SCENES｜三类重点制造场景</span><h2 id="qily-home-industry-title">聚焦高相关制造场景，让工程方法直接对应现场问题</h2><p>覆盖汽车电子、新能源材料与装备／离散制造，以工程数据、现场诊断与可复用方法支撑效率、质量、交付和规划改善。</p></div>'
  ...
  function buildCases(){
    return node(''
      ...
      +'<div class="qily-home-conversion-inner">'
      +'<div class="qily-home-conversion-heading"><span class="qily-home-conversion-kicker">REPRESENTATIVE CASES｜三个代表案例</span><h2 id="qily-home-cases-title">以真实项目成果验证工程交付能力</h2><p>从新工厂规划、快速换型到智能模具库，以项目现场、工程方法和可核验结果呈现交付能力。</p></div>'
      +'<div class="qily-home-card-grid">'
  ...
  function transformMethod(section){
    ...
    section.innerHTML=''
      +'<div class="qily-home-conversion-inner">'
      +'<div class="qily-home-conversion-heading"><span class="qily-home-conversion-kicker">QILYLEAN METHOD｜六步方法</span><h2 id="qily-home-method-title">从问题到组织能力，用六个阶段完成闭环</h2><p>从问题初筛、现场诊断到Pilot验证、标准固化与验收复制，形成可实施、可验证、可延续的改善闭环。</p></div>'
  ...
  function buildCollaboration(){
    return node(''
      ...
      +'<div class="qily-home-conversion-inner">'
      +'<div class="qily-home-conversion-heading"><span class="qily-home-conversion-kicker">OWNER & COLLABORATION｜主理人与合作能力</span><h2 id="qily-home-collaboration-title">核心工程判断由QilyLean主理，专业资源按项目边界协同</h2><p>QilyLean负责核心工程判断与项目主线，专项资源按明确边界协同实施与验收。</p></div>'
