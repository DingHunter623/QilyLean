(function () {
  ...
  if (window.__qilyLeanSiteNavigationPublicV6) return;
  window.__qilyLeanSiteNavigationPublicV6 = true;

  var HOME_URL = 'https://qilylean.com/';
  var HOME_QR_SRC = '/qilylean/qilylean-home-qr.svg?v=20260722-navigation-v4';
  var SHARED_ASSET_VERSION = '20260728-layout-type-v3';
  var VISUAL_SCALE_VERSION = '20260728-layout-type-v3';
  ...
  function addWideLayoutStylesheet() {
    ...
    if (current) {
      current.href = '/site-wide-layout-v1.css?v=20260728-balanced-layout-v4';
      return;
    }
    var link = document.createElement('link');
    link.id = 'qilyWideLayoutStylesheet';
    link.rel = 'stylesheet';
    link.href = '/site-wide-layout-v1.css?v=20260728-balanced-layout-v4';
    document.head.appendChild(link);
  }
  ...
  function addTypographyStylesheet() {
    ...
    if (current) {
      current.href = '/site-typography-v1.css?v=20260728-type-system-v3';
      return;
    }
    var link = document.createElement('link');
    link.id = 'qilyTypographyStylesheet';
    link.rel = 'stylesheet';
    link.href = '/site-typography-v1.css?v=20260728-type-system-v3';
    document.head.appendChild(link);
  }
