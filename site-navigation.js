/* QilyLean global VI, navigation, trust and conversion loader v8 */
(function (d, w) {
  'use strict';
  if (w.__qilyGlobalAssetLoaderV8) return;
  w.__qilyGlobalAssetLoaderV8 = true;
  ...
  function ensureGlobalAssets() {
    ...
    [
      ...
      ['qilyTrustConversionV2Stylesheet', '/site-trust-conversion-v2.css?v=20260805-trust-conversion-v2']
  ...
  function promoteVi() {
    ...
    [
      'qilyViStandardStylesheet',
      'qilyViContrastRestorationStylesheet',
      'qilyVisualClosureStylesheet',
      'qilyBoundaryLinksClosureStylesheet',
      'qilyTrustConversionV2Stylesheet'
    ].forEach(function (id) {
      var current = d.getElementById(id);
  ...
  promoteVi();
  setTimeout(promoteVi, 120);
  setTimeout(promoteVi, 600);
  setTimeout(promoteVi, 1500);
  setTimeout(promoteVi, 3000);
})(document, window);

/* QilyLean layered navigation build contract v8 */
window.__qilyLayeredNavigationBuildContract = Object.freeze({
  shellAssets: [
    ...
    'site-trust-conversion-v2.css?v=20260805-trust-conversion-v2',
...
/* QilyLean global navigation wrapper｜保留原导航功能并加载可信度、信息架构与商业转化闭环 */
(function (d, w) {
  'use strict';
  if (w.__qilyNavigationWrapper20260805V14) return;
  w.__qilyNavigationWrapper20260805V14 = true;
  ...
  function loadEnhancers() {
    ...
    ensureStylesheet('qilyTrustConversionV2Stylesheet', '/site-trust-conversion-v2.css?v=20260805-trust-conversion-v2');
  ...
  function appendLegacy() {
    if (d.querySelector('script[data-qily-navigation-legacy]')) {
      loadEnhancers();
      return;
    }
