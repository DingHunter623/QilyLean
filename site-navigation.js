...
(function (d, w) {
  ...
  function ensureGlobalAssets() {
    ...
    [
      ...
      ['qilyInteractiveHoverContrastStylesheet','/site-interactive-hover-contrast-v1.css?v=20260809-sitewide-interaction-clarity-v6']
...
window.__qilyLayeredNavigationBuildContract = Object.freeze({
  shellAssets:[
    ...
    'site-interactive-hover-contrast-v1.css?v=20260809-sitewide-interaction-clarity-v6',
...
(function (d, w) {
  ...
  function loadEnhancers() {
    ...
    ensureStylesheet('qilyInteractiveHoverContrastStylesheet','/site-interactive-hover-contrast-v1.css?v=20260809-sitewide-interaction-clarity-v6');
