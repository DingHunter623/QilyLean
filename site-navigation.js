...
(function (d, w) {
  ...
  function ensureGlobalAssets() {
    ...
    [
      ...
      ['qilyInteractiveHoverContrastStylesheet','/site-interactive-hover-contrast-v1.css?v=20260809-sitewide-interaction-clarity-v10']
...
window.__qilyLayeredNavigationBuildContract = Object.freeze({
  shellAssets:[
    ...
    'site-interactive-hover-contrast-v1.css?v=20260809-sitewide-interaction-clarity-v10',
...
(function (d, w) {
  ...
  function loadEnhancers() {
    ...
    ensureStylesheet('qilyInteractiveHoverContrastStylesheet','/site-interactive-hover-contrast-v1.css?v=20260809-sitewide-interaction-clarity-v10');
  ...
  function appendLegacy() {
    ...
    legacy.src = '/site-navigation-legacy-20260802.js?v=20260809-six-capability-pricing-v3';
    legacy.async = false;
