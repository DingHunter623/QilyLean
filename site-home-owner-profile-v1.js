/* QilyLean Homepage Owner Profile V2 | 2026-09-01
...
(function(d,w){
  'use strict';
  if(w.__qilyHomeOwnerProfileV2)return;
  w.__qilyHomeOwnerProfileV2=true;
  ...
  function apply(){
    ...
    if(card.querySelector('.qily-home-owner-profile'))return true;
    ...
    profile.innerHTML='<strong>丁启利｜20年制造业工程技术与精益改善履历</strong><p>QilyLean启力精益由丁启利发起，作为制造改善、项目交流与精益赋能窗口。其中9年任职欧美企业，先后从事TE、IE工程工作；4年担任上市公司工程部长；累计6年多从事咨询交付。长期聚焦PQCD改善、数智化工厂规划、目视化项目交付与精益体系建设。</p><a class="qily-home-owner-profile__experience" href="/experience/" aria-label="查看丁启利履历主线">查看履历主线 →</a>';
