/* QilyLean CN Primary Navigation Rail V1 | 2026-09-18
 * Mirrors the international-site primary navigation range rail.
 */
(function(d,w){'use strict';
if(w.__qilyCnNavRailV1)return;w.__qilyCnNavRailV1=true;
...
w.addEventListener('resize',resync,{passive:true});w.addEventListener('pageshow',boot,{passive:true});
})(document,window);
