...
function addSection(){
  ...
  section.innerHTML='<div class="times26001-home-inner"><div class="times26001-home-head"><h2>数字化工具作品</h2><p>将工业工程测时需求与日常时间管理结合，形成可直接使用、可持续迭代的移动端工具；Android v1.1.4现已开放官网下载。</p></div><article class="times26001-home-card"><figure class="times26001-home-visual"><a href="/tools/times26001/" aria-label="查看Times26001应用介绍"><img src="/assets/tools/times26001-overview.svg?v=20260805-android-v114" alt="Times26001思大时间管理APP功能概览" width="1200" height="720" loading="lazy" decoding="async"></a></figure><div class="times26001-home-content"><small>移动端APP｜时间管理＋IE现场测时</small><h3>Times26001｜思大时间管理</h3><p>"QilyLean AI | 启力精益"为IE时间分析自主开发的时间工具。集成北京时间、万年历、闹钟响铃、秒表分段、总时长汇总、按秒倒计时、黄历与节气信息，可用于标准工时测量、工序分析和改善前后对比。</p><ul class="times26001-feature-list"><li>北京时间、阳历、农历、节气与节假日</li><li>一次性、工作日、周末及自定义提醒</li><li>秒表分段、总计汇总与文本复制</li><li>预设／自定义倒计时及离线通知</li><li>黄历宜忌、冲煞与传统时间信息</li><li>Android v1.1.4已开放直接下载</li></ul><div class="times26001-home-actions"><a class="download" href="/Times26001-Android-v1.1.4-IE-Stopwatch.apk?build=81c7653c" download>Android直接下载 v1.1.4</a><a class="secondary" href="/tools/times26001/">查看APP介绍</a><button class="secondary" type="button" data-copy-times26001>复制分享简介</button><span class="times26001-home-status" aria-live="polite"></span></div></div></article></div>';
  ...
  button.addEventListener('click',function(){
    var text='"QilyLean AI | 启力精益"为IE时间分析自主开发的时间工具。Times26001 Android v1.1.4支持闹钟响铃、秒表分段、总时长汇总、按秒倒计时及结束响铃通知，现已开放官网直接下载。\nhttps://qilylean.com/tools/times26001/';
