(function(){
  ...
  function boot(){load('homepage-depth.js?v=depth2','homepageDepthScript');load('content-restore.js?v=restore-entries2','contentRestoreScript');load('voice-drag-ensure.js?v=drag1','voiceDragEnsureScript');load('contact-wechat-open.js?v=wechat-open1','contactWechatOpenScript')}
