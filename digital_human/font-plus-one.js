(function(){
  ...
  css.textContent = `
    ...
    @media(max-width:760px){body{font-size:18.5px!important}.answer{font-size:20px!important}.head p,.card p,.timeline p,.project p,.paper-card p,.method-card p,.contact p,textarea{font-size:19px!important}}
  `;
