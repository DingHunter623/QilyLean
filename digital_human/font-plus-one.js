(function(){
  ...
  function boot(){load('homepage-depth.js?v=depth3','homepageDepthScript');load('content-restore.js?v=restore-entries3','contentRestoreScript');load('ui-manager.js?v=ui1','uiManagerScript');load('career-resume-full.js?v=career-full1','careerResumeFullScript')}
