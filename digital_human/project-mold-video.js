(function(){
'use strict';
if(!/(?:home|home-live)\.html$|digital_human\/?$/i.test(location.pathname)||document.getElementById('moldWarehouseProjectVideo'))return;
function mount(){
  ...
  box.innerHTML='<h4>项目现场视频｜智能模具库运行实录</h4><video controls preload="metadata" playsinline poster="../mold-smart-warehouse.png"><source src="../zhinengmujuku.mp4?v=20260718" type="video/mp4">您的浏览器暂不支持视频播放。</video><p>1200+副模具立体库｜库位管理、存取运行与数字化追溯现场记录</p>';
