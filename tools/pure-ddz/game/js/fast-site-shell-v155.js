(() => {
  ...
  const FREE_CHOICE_PATCH='/tools/pure-ddz/game/js/free-choice-v176.js?v=20260915-ddz-free-choice-v176';
  ...
  function loadLandscapePatch(){
    if(document.querySelector('script[data-qily-ddz-mobile-autofit="v165"]'))return;
    const script=document.createElement('script');
    script.src=LANDSCAPE_PATCH;
    script.async=false;
    script.dataset.qilyDdzMobileAutofit='v165';
    document.head.appendChild(script);
  }

  function loadUxPatch(){
    if(document.querySelector('script[data-qily-ddz-mobile-ux="v168"]'))return;
    const script=document.createElement('script');
    script.src=UX_PATCH;
    script.async=false;
    script.dataset.qilyDdzMobileUx='v168';
    document.head.appendChild(script);
  }
  ...
  function loadParentFriendlyPatch(){
    if(document.querySelector('script[data-qily-ddz-parent-friendly="v171"]'))return;
    const script=document.createElement('script');
    script.src=PARENT_FRIENDLY_PATCH;
    script.async=false;
    script.dataset.qilyDdzParentFriendly='v171';
    document.head.appendChild(script);
  }

  function loadFreeChoicePatch(){
    if(document.querySelector('script[data-qily-ddz-free-choice="v176"]'))return;
    const script=document.createElement('script');
    script.src=FREE_CHOICE_PATCH;
    script.async=false;
    script.dataset.qilyDdzFreeChoice='v176';
    document.head.appendChild(script);
  }
  ...
  window.QilyLeanDdzFastShell=Object.freeze({version:'1.5.5-v176',loadTranslation});
})();