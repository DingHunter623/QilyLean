...
(function () {
  ...
  var CORE_SRC = '/site-navigation-core.js?v=20260807-enterprise-contact-standard-v2';
  ...
  var factoryPricing = [
    ...
    { code: 'LAYOUT｜车间规划', title: '车间布局优化规划', price: '¥38,000起', description: '围绕设备、工位、产能、人流、物流、仓储、WIP及安全通道形成可执行、可评审的布局方案。', basis: '常规参考：约18～30元/㎡；最低启动价与面积核价取高值。' },
    ...
    { code: 'DELIVERY｜协同实施', title: '智能工厂整体规划与协同实施', price: '¥480,000起', description: '覆盖规划深化、多专业协同、供应商接口、实施推进、投产爬坡、现场验证和阶段验收；施工、设备、软件与专业工程由相应供应商或外协方实施。', basis: '2026面积参考：约3.0～5.0万元/亩；复杂项目按范围评估。' }
  ];
  ...
  function renderCooperationPrices(ladder, note) {
    ...
    note.hidden = false;
    note.innerHTML = '<strong>统一价格说明：</strong>现场诊断与规划建议保持¥6,800起＋差旅。新工厂项目以最低启动价和面积核价取高值；概念规划参考1.2～1.8万元/亩，深化规划参考2.0～3.0万元/亩，整体规划与协同实施参考3.0～5.0万元/亩。最终费用依据产品工艺、设备数量、自动化与数字化范围、数据基础、现场投入、交付深度、修改次数及实施周期综合评估。制作、施工、设备、软件、检测、报审、设计院和第三方费用按合同边界另计。';
  }
