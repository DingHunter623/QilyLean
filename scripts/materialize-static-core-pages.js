...
<section class="qily-ia-section" id="qily-core-services" data-qily-static-source="home-core-v2" data-qily-three-core-services="v1">
  <div class="qily-ia-inner">
    ...
    <div class="qily-ia-support-heading"><span>ENGINEERING ENABLERS｜不计入核心业务</span><h3>数智化增强能力与自主数字作品</h3><p>数字化工厂用于增强三大业务的流程、数据和系统落地；QilyLean AI／APP与本官网用于证明把制造逻辑转化为可运行数字工具和专业资产的能力。</p></div>
    <div class="qily-ia-grid qily-ia-support-grid">
      ...
      <article class="qily-ia-card" data-qily-business-line="evidence"><small>自主数字作品</small><h3>QilyLean官网</h3><p>以信息架构、证据治理、SEO、响应式体验和持续运维，验证专业内容资产化能力。</p><div class="qily-ia-result">官网本身作为技术实证，不列为核心业务</div></article>
    </div>
...
<section class="qily-ia-section qily-ia-alt" id="qily-home-proof" data-qily-static-source="home-proof-v2">
  <div class="qily-ia-inner">
    ...
    <div class="qily-ia-delivery-summary">
      ...
      <article><strong>交易机制</strong><span>三大核心业务均明确范围、交付物与验收边界；数智化增强能力按具体项目需要嵌入，不另行包装成核心业务。</span></article>
