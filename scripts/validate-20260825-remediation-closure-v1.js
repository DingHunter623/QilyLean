...
const cn=read(CN);must(cn,'name="robots" content="index,follow"','CN production indexing');must(cn,'/assets/qilylean-vi-v2.css?v=20260923-cn-vi-v21-heading-scale','CN independent VI authority');must(cn,'/assets/cn-nav-rail-v1.js?v=20260922-nav-rail-v8-current-module','CN independent navigation runtime');must(cn,'/assets/cn-translate-baidu-v1.js?v=20260922-translate-v6-baidu','CN independent translation runtime');must(read('cn-site/assets/qilylean-vi-v2.css'),'QILY-CN-CURRENT-MODULE-V1','CN current-module VI contract');
