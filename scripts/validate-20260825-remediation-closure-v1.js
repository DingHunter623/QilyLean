...
console.log(`PASS: V26 remediation closure covers ${pages} public pages — persistent nav rail, inert static vocabulary, Dock full-contact route and DDZ safe centering.`);
