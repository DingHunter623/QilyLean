...
home_block = '''      <article class="module-card capability-digital-tool" id="qilylean-home" data-qily-home-card="v2.3.3-full">
        <div class="capability-digital-visual capability-home-visual">
          <div class="capability-home-screen">
            ...
            <div class="capability-home-shortcuts" aria-label="QilyLean Home当前主要入口"><span>首页</span><span>履历主线</span><span>能力体系</span><span>改善工具</span><span>代表项目</span><span>信任中心</span><span>项目合作</span><span>知识资产</span><span>全站术语</span><span>友情链接</span><span>Times26001</span><span>系统设置</span><span>应用抽屉</span></div>
          </div>
        </div>
        <div class="capability-digital-content">
          <span class="module-eyebrow">数字工具作品 | 安卓通用品牌桌面</span>
          <h3>QilyLean Home | 官网通用安装包</h3>
          <p><strong>“QilyLean｜启力精益”面向常见安卓手机自主开发的免 Root 品牌桌面。</strong> 按照官网当前 R5 导航顺序，将首页、履历主线、能力体系、改善工具、代表项目、信任中心、项目合作、知识资产完整集中到手机桌面；同时保留全站术语、友情链接等知识重点直达入口，并与 Times26001 数字工具联动。</p>
