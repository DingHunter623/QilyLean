...
replacements = {
    "Android通用品牌桌面 v1.0": "Android官网全导航通用版 v2.1",
    ...
    'Android通用版 v1.0｜免Root｜可设为默认桌面｜官网核心入口＋通用设置＋全部应用抽屉': 'Android通用版 v2.1｜免Root｜官网首页全导航｜重点内容直达＋通用设置＋全部应用抽屉',
    '<a href="/QilyLean_Home_Universal_v1.0.apk?build=096cf0389446627" download>Android通用版下载</a>': '<a href="/QilyLean_Home_Universal_v2.1.apk?build=dc8ba9ddff23" download>Android通用版 v2.1下载</a>',
}
...
if changed:
    ...
    print("Updated capabilities/index.html for QilyLean Home v2.1")
else:
    print("capabilities/index.html is already current for QilyLean Home v2.1")
