...
must(materializer,"TRANSLATION_SAFE_JS='/site-translation-safe-runtime-v1.js?v=20260901-google-translate-single-runtime-v16'",'Google Translate V1.3 cache');
must(materializer,"TRANSLATION_PUBLIC_CSS='/site-translation-public-ui-v1.css?v=20260901-google-translate-mobile-ui-v16'",'Google native translation UI cache');
...
must(translationRuntime,'reload-free mobile closure','Non-blocking translation closure');
...
console.log('PASS: V27 compatibility checks remain satisfied on the V32 post-load Google-Translate/native-range baseline, including reload-free translation, governed axes, readable evidence grades, native phone navigation, translation utility integrity and portrait-ready DDZ automation.');
