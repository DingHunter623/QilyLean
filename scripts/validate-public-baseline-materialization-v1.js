...
console.log(`PASS: ${audited} standard public pages use the V32 baseline and Dock V5.8 authority; DDZ V155/V164 remains the single explicitly isolated fast route and accepts the canonical V5.8 cache before/after materialization.`);
