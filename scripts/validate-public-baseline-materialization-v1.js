...
if(failures.length)throw new Error(`V26 public materialization failed (${failures.length}):\n${failures.slice(0,50).join('\n')}`);
console.log(`PASS: ${audited} public pages carry V26; visible nav rail, inert vocabulary semantics V1.4, Contact V13.4/Dock V5.4 and DDZ V132 are materialized.`);
