...
console.log(`PASS: ${audited} public pages use Google Translate V1.3 + mobile-native navigation under V32 with the English public label and no retired translation stack.`);
