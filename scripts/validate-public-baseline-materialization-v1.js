...
const required=[
  ...
  '/site-header-axis-v1.css?v=20260825-header-axis-nav-fit-v2',
  '/site-translation-public-ui-v1.css?v=20260825-public-language-picker-v6',
...
process.stdout.write(`PASS: ${audited} tracked HTML pages carry one unified safe translation/readability baseline; no retired external-proxy translator remains referenced.\n`);
