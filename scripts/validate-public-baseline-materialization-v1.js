...
const required=['/site-header-axis-v1.css?v=20260829-primary-navigation-safe-scroll-v7','/site-interaction-semantics-v1.css?v=20260830-r11-semantics-v14-visual-v3-vi-teal','/site-interaction-semantics-v1.js?v=20260831-r11-semantics-v17-native-range','data-qily-interaction-semantics-direct="v1.7"','/site-visual-components-v1.css?v=20260831-unified-components-v29-native-range','/site-translation-public-ui-v1.css?v=20260831-google-translate-mobile-ui-v14','data-qily-translation-public-ui="google-v1"','/site-translation-safe-runtime-v1.js?v=20260831-google-translate-header-v12-visible','data-qily-translation-safe-direct="google-v1"','/site-responsive-containment-v1.css?v=20260830-header-integrity-v2','/site-header-project-integrity-v2.css?v=20260831-project-grade-readability-v3','/site-contact-route-v1.js?v=20260829-dock-functional-public-v134','data-qily-contact-route-direct="v13.4"','/site-public-redline-closure-v2.css?v=20260830-annotated-v2','/site-public-redline-closure-v2.js?v=20260831-english-label-v23','data-qily-public-redline-v2-direct="annotated-v2"'];
const forbidden=['data-qily-translation-safety-bootstrap','site-translation-public-ui-v1.js','site-translation-progress-v1.js','site-translation-progress-v1.css','site-global-language-v1.css','site-global-language-v3.js','20260831-safe-inpage-v7-header-utility','data-qily-translation-safe-direct="v7"'];
...
for(const sample of ['index.html','trust/index.html','experience/index.html','projects/index.html','qilylean/daily/2026-08-25.html','qilylean/daily/2026-07-29.html']){
  const html=read(sample);for(const token of required)if(!html.includes(token))failures.push(`${sample}: required V31 asset absent (${token})`);for(const token of forbidden)if(html.includes(token))failures.push(`${sample}: retired translator remains (${token})`);
}
...
console.log(`PASS: ${audited} public pages use Google Translate V1.2 + mobile-native navigation under V31 with the English public label and no retired translation stack.`);
