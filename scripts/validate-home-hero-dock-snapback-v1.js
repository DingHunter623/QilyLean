...
assert(home.includes('/site-global-language-v3.js?v=20260825-google-translate-on-demand-v1'), 'homepage does not directly reference Chinese-default Google Translate on-demand runtime');
assert(home.includes('data-qily-google-translate-direct="on-demand-v1"'), 'homepage is missing Google Translate on-demand direct marker');
...
process.stdout.write('PASS: homepage Hero V3 and Dock Snapback V3 remain protected; Chinese default display and Google Translate on-demand runtime are materialized without arbitrary Dock-position persistence.\n');
