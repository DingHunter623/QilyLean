...
const runtime='/site-global-language-v3.js?v=20260825-google-translate-on-demand-v1';
const homeReady=home.includes(runtime)&&home.includes('data-qily-google-translate-direct="on-demand-v1"');
const publishReady=materializer.includes(runtime)&&materializer.includes('data-qily-google-translate-direct="on-demand-v1"');
...
assert(homeReady||publishReady,'Chinese-default Google Translate on-demand contract is neither materialized nor queued');
...
process.stdout.write('PASS: homepage Hero V3 and Dock Snapback V3 remain protected; Chinese-default Google Translate on-demand contract is controlled by the sitewide materializer.\n');
