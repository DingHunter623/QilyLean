...
/* Homepage / Dock snapback compatibility gate | V33 | 2026-09-03 */
...
must(dock,'Floating Dock Authoritative Runtime V5.5','Dock V5.5');must(dock,'__qilyFloatingDockUnifiedV55','Dock V55 guard');must(dock,'setOwnedLabel','Dock label owner');must(dock,"w.open(url,'_blank','noopener,noreferrer')",'Contact new tab');must(dock,'function isExcluded(){return false;}','Public Dock coverage');forbid(dock,"mask.classList.add('show')",'Dock modal');
...
const resources=[
  ...
  [['/site-dock-share-runtime-v1.js?v=20260829-authority-v54','/site-dock-share-runtime-v1.js?v=20260906-authority-v57-mobile-fixed-bottom','/site-dock-share-runtime-v1.js?v=20260906-authority-v57-mobile-fixed-bottom'],'Dock'],
...
console.log('PASS: V33 homepage guard protects aircraft hero, VI deep-teal native-range navigation, Google Translate V1.4, readable project grades and authoritative Dock V5.5 while accepting already-materialized V5.4 page cache during transition.');
