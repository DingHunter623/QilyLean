...
function patchSearchAndData() {
  ...
  index.entries.push({
    url: previewUrl,
    title: 'QilyLean项目保密声明｜在线预览',
    code: 'CONFIDENTIALITY',
    description: 'QilyLean制造改善项目一页精简版保密声明在线预览；覆盖调研资料、图片、商业信息、人员信息和成果资料保密要求。',
    headings: '信任中心｜客户数据、隐私与保密｜项目合作',
    text: '保密声明 在线预览 调研数据 产品信息 未上市产品 图片 视频 原始资料 归还 删除 销毁 商业信息 人员信息 参观管理 项目成果 脱敏 精益改善 工业工程 数智化工厂',
    kind: '法律与合作范本',
    date: buildDate
  });
  ...
  index.meta.ndaDocumentName = 'QilyLean项目保密声明';
  ...
  data.compliance.ndaDocumentName = 'QilyLean项目保密声明';
  data.compliance.ndaPreviewUrl = previewUrl;
  data.compliance.ndaAccessRule = '官网仅开放受控在线预览，不提供Word或PDF下载入口。';
  data.compliance.ndaContentRule = '网站PDF与交付Word由同一DOCX源文件生成，内容保持一致；Word不在官网公开。';
...
process.stdout.write(`Published QilyLean confidentiality statement preview and synchronized ${count} search entries.\n`);
