...
page=page.replace(/const version='[^']+';/, "const version='20260828-elder-ux-v127';");
page=page.replace(/window.__PURE_DDZ_CACHE_KEY__\|\|'[^']+'/g, "window.__PURE_DDZ_CACHE_KEY__||'20260828-elder-ux-v127'");
...
if(!page.includes("const version='20260828-elder-ux-v127';")) throw new Error('DDZ elder UX cache key not updated');
if(!page.includes("window.__PURE_DDZ_CACHE_KEY__||'20260828-elder-ux-v127'")) throw new Error('DDZ fallback cache key not updated');
...
if(page!==before){
  ...
  console.log('Updated tools/pure-ddz/index.html with elder UX v1.2.7 release');
}else{
  console.log('Pure DDZ elder UX v1.2.7 public UI already current.');
}
