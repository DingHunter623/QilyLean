...
if(!page.includes('/site-dock-share-runtime-v1.js?')){
  page=page.replace(/<\/head>/i,'  <script defer data-qily-dock-share-runtime="v1" src="/site-dock-share-runtime-v1.js?v=20260906-authority-v57-mobile-fixed-bottom"></script>\n</head>');
}
