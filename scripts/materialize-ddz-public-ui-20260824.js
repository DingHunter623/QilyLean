...
const before=page;
const CACHE='20260902-ddz-integrated-v150';
...
// Retire page-level patch stacking. V150 owns the DDZ page layout; old V141 and R8 layout closures must stay unloaded.
...
if(!page.includes("const chain=['js/card-theme.js','js/ai-expert.js','js/game.js','js/visual-v120.js'];")) throw new Error('DDZ V150 core runtime chain is missing');
...
if(page!==before){
  ...
  console.log('Updated tools/pure-ddz/index.html with integrated V150 public-page runtime');
}else{
  console.log('Pure DDZ integrated V150 public UI already current.');
}