...
const interactionAsset = '/site-static-core-interactions-v1.js?v=20260803-static-text-lock-v4';
const linkStandardAsset = '/site-link-standard-v2.css?v=20260803-static-card-lock-v7';
let html = fs.readFileSync(file, 'utf8');

/*
 * QILY-HOME-STATIC-METRIC-NO-HOVER
 * Static result cards must be visually identical before, during and after
 * pointer, focus and active states. Geometry, borders, background and every
 * text layer are locked to their normal static values.
 */
...
console.log('Homepage static result cards now preserve identical text colors, borders and geometry in every state.');
