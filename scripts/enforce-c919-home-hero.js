...
<section class="qily-c919-hero" id="qily-c919-strategy" aria-labelledby="qily-c919-title">
  <div class="qily-c919-shell">
    ...
    <div class="qily-c919-soul">
      ...
      <p class="qily-c919-copy">左翼承载<strong>新工厂／新产线规划、精益改善项目交付、目视化项目设计与交付</strong>，右翼延展<strong>数字化工厂、APP软件开发、官网建设</strong>；机身凝聚精益思维、系统逻辑、数据驱动、标准化、流程优化、持续改善、项目交付与价值创造。以六类核心业务为翼，以方法论与工程技术为核，<strong>助企业高质量发展</strong>，也让<strong>启力精益展翼远航</strong>。</p>
...
setMeta('og:image','https://qilylean.com/qilylean/c919-strategy-hero.png');
...
setMeta('twitter:image','https://qilylean.com/qilylean/c919-strategy-hero.png','name');
...
console.log('C919 homepage hero enforced: static first position, soul summary, six-core business language and social metadata updated.');
