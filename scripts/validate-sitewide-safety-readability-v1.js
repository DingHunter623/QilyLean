...
must(mat,"DOCK_SHARE='/site-dock-share-runtime-v1.js?v=20260906-authority-v58-mobile-swipe-fixed-bottom&patch=20260906-mobile-compact-fixed-r1'",'Dock V58 materialization owner');
...
console.log('PASS: safety/readability owners retain official sticky Header and Dock V5.8 while the isolated DDZ V155/V164 route preserves bundled first paint, user-gesture landscape rotation and actual-viewport adaptive sizing.');
