...
requireText(shell,"BUILD_ID='20260827-primary-navigation-unified-v4'",'Unified primary-navigation shared shell');
...
requireText(shell,"publicCss:'/site-translation-public-ui-v1.css?v=20260827-primary-navigation-unified-v8'",'Unified primary-navigation public UI CSS');
requireText(shell,"headerCss:'/site-header-axis-v1.css?v=20260827-primary-navigation-unified-v4'",'Unified primary-navigation header CSS');
...
requireText(navigation,"var HEADER_AXIS_HREF = '/site-header-axis-v1.css?v=20260827-primary-navigation-unified-v4'",'Unified navigation header runtime');
requireText(navigation,"var CONSISTENCY_SRC = '/site-ui-consistency-v1.js?v=20260827-primary-navigation-unified-v45'",'Unified navigation shared-shell runtime');
...
requireText(materializer,"const NAVIGATION = '/site-navigation.js?v=20260827-primary-navigation-unified-v45'",'Unified navigation materialization');
requireText(materializer,"const CONSISTENCY = '/site-ui-consistency-v1.js?v=20260827-primary-navigation-unified-v45'",'Unified shell materialization');
...
process.stdout.write('PASS: sitewide contracts cover unified primary navigation, fast fail-closed translation, deterministic search opening, one terminology strip, and V6 readable dark/light structural surfaces.\n');
