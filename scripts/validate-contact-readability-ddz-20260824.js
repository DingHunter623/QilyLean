...
/* DDZ is an ordinary QilyLean page. Its own files may govern only the game module, never the site shell/Dock. */
const ddz=read('tools/pure-ddz/index.html');
["const version='20260903-ddz-mobile-landscape-v153'","loadStyle('css/card-comfort-v122.css')","loadStyle('css/ddz-site-page-v140.css')","loadStyle('css/mobile-landscape-v153.css')",'id="welcome-start"','id="welcome-landscape"','id="v120-landscape-toggle"','/site-navigation.js?','/site-dock-share-runtime-v1.js?','<p id="hint-message" class="hint-message" aria-hidden="true"></p>','无牌可压时自动喊“不要”并轮到下家'].forEach(x=>assert(ddz.includes(x),'斗地主公开入口契约缺失：'+x));
['qilyPureDdzR8ClosureV128','ddz-site-shell-v140.js','js/qilylean-theme.js','js/elder-assist-v140.js','<footer class="site-footer">','class="ddz-page-note"','name="screen-orientation"','name="x5-orientation"'].forEach(x=>assert(!ddz.includes(x),'斗地主退役页面契约重新出现：'+x));
...
const visualRuntime=read('tools/pure-ddz/game/js/visual-v120.js');
...
console.log('PASS: V36 behavior owners remain stable: official sticky Header, native-range navigation, Google Translate V1.4, canonical Dock V5.5 and DDZ V153 adaptive mobile landscape integration.');
