...
/* Contact / readability / DDZ compatibility gate | V35 | 2026-09-02 */
...
["const version='20260902-ddz-integrated-v152'","loadStyle('css/card-comfort-v122.css')","loadStyle('css/ddz-site-page-v140.css')",'id="welcome-start"','/site-navigation.js?','/site-dock-share-runtime-v1.js?','<p id="hint-message" class="hint-message" aria-hidden="true"></p>','无牌可压时自动喊“不要”并轮到下家'].forEach(x=>assert(ddz.includes(x),'斗地主公开入口契约缺失：'+x));
...
assert(ddzLayout.includes('height:clamp(560px,calc(100vh - 260px),620px)'),'斗地主纵向工作区未按 V152 收口');
...
console.log('PASS: V35 behavior owners remain stable: official sticky Header, native-range navigation, Google Translate V1.4, canonical Dock V5.5 and DDZ V152 elder-paced site integration.');
