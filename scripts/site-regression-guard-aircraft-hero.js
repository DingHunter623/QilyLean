...
const EXPECTED_SOURCE_BLOB='85208c107a39724b97a07e05819ed88e6cfcdc90';
...
assert(png.length===2326182,'Canonical PNG byte size changed unexpectedly');
...
const modern=block.includes('qilylean-aircraft-hero-latest-q98.webp?v=20260829-official-qr-v4');
if(modern){
  ...
  assert(block.includes('qilylean-aircraft-hero-approved-20260826.png?v=20260829-official-qr-v4'),'Canonical PNG fallback missing');
  ...
  assert(html.includes('<link id="qilyAircraftHeroPreloadV1" rel="preload" as="image" href="/assets/qilylean-aircraft-hero-latest-q98.webp?v=20260829-official-qr-v4" type="image/webp" fetchpriority="high">'),'Optimized aircraft preload missing');
}else{
