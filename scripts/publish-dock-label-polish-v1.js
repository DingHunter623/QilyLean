...
const CONSISTENCY_SRC='/site-ui-consistency-v1.js?v=20260815-dock-label-v6';
const FAST_NATIVE_SRC='/site-music-persistent-navigation-v1.js?v=20260815-prefetch-v6p1';
const DIRECT_TAG=`<script defer data-qily-ui-consistency="dock-v6" src="${CONSISTENCY_SRC}"></script>`;
