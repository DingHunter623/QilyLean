...
s=s.replace(
    ...
    "<div class=\"qily-email-list\"><div>官网</div><a class=\"qily-contact-email\" href=\"https://qilylean.com/\">https://qilylean.com/</a></div><div class=\"qily-email-list\"><div>官网邮箱</div><a class=\"qily-contact-email\" href=\"mailto:' + CONTACT_EMAIL + '\">' + CONTACT_EMAIL + '</a>"
)
s=s.replace(
