...
const css='/site-core-service-dock-closure-v1.css?v=20260804-core-service-dock-v1';
const js='/site-core-service-dock-closure-v1.js?v=20260804-core-service-dock-v1';
const cssTag=`  <link id="qilyCoreServiceDockClosureStylesheet" rel="stylesheet" href="${css}">`;
const jsTag=`  <script defer data-qily-core-service-dock-closure="v1" src="${js}"></script>`;
...
process.stdout.write(`Core-service and compact-dock closure installed in ${checked} pages; refreshed ${changed}.\n`);
