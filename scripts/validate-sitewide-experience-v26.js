...
forbid(ddzHtml,'name="screen-orientation"','DDZ forced orientation');forbid(ddzHtml,'name="x5-orientation"','DDZ forced X5 orientation');forbid(ddzHtml,'qilyPureDdzR8ClosureV128','DDZ retired closure');must(ddzHtml,'Promise.all(chain.map','DDZ parallel resource download');must(ddzHtml,'},1800);','DDZ early interface reveal');must(ddzHtml,'20260903-ddz-fast-knowledge-v155','DDZ V155 cache');must(ddzHtml,'data-qily-ddz-fast-shell="v155"','DDZ V155 fast shell');must(ddzHtml,"loadStyle('css/ddz-core-v155.css')",'DDZ bundled stylesheet');must(ddzHtml,"const chain=['js/ddz-core-v155.js'];",'DDZ bundled core');must(ddzHtml,'/site-dock-share-runtime-v1.js?','DDZ canonical Dock runtime');
