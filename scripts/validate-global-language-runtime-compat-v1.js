...
requireText(consistency,"BUILD_ID='20260827-primary-navigation-unified-v4'",'Unified primary-navigation shared-shell build');
...
requireText(materializer,"const CONSISTENCY = '/site-ui-consistency-v1.js?v=20260827-primary-navigation-unified-v45'",'Unified shared-shell cache bust');
requireText(materializer,"const NAVIGATION = '/site-navigation.js?v=20260827-primary-navigation-unified-v45'",'Unified navigation cache bust');
...
process.stdout.write(`PASS: QilyLean public baseline ${runtimeBaseline} uses one primary-navigation visual contract, visible-first fail-closed in-page translation, endpoint reuse, deterministic progress, non-blocking loading, full language labels and V6 readable surfaces.\n`);
