...
for(const [t,m] of [
  ...
  ['/site-dock-share-runtime-v1.js?v=20260906-authority-v56-flow-navigation','DDZ canonical Dock']
])must(ddzIndex,t,m);
...
for(const [t,m] of [
  ...
  ["const DOCK_SHARE='/site-dock-share-runtime-v1.js?v=20260906-authority-v56-flow-navigation'",'Dock V56 materializer'],
...
console.log(`PASS: ${baseline} compatibility preserves one Google Translate V1.4 owner, native navigation, Dock V5.6, formal VI v4, CN noindex preproduction, and the isolated DDZ V155/V164 fast route.`);
