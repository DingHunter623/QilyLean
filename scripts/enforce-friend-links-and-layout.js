...
/* QilyLean 友情链接 + 版式永久防回退｜2026-09-16
 ...
 * 6) 国际站 /links/ 显式关联 QilyLean 中国知识站 qilylean.cn，但该入口独立于“全球科技企业100强”企业收录与排名；
 * 7) 该脚本为友情链接与中国知识站关联的唯一物化入口，CI 推送后自动生成公开页面。
 */
const fs=require('fs');
...
function patchLinks(){
  ...
  const chinaKnowledgeBlock='<!-- QILY-CHINA-KNOWLEDGE-BRIDGE:START -->\n      <div class="notice" id="qilyChinaKnowledgeBridge"><strong>QilyLean 中国知识站：</strong> <a class="resource-action" href="https://qilylean.cn/" target="_blank" rel="noopener" aria-label="进入 QilyLean 中国知识站">进入 QilyLean 中国知识站 ↗</a> <span>qilylean.cn 为 QilyLean 制造知识体系的中国大陆个人知识与实践分享站，聚焦精益生产、工业工程、标准化、工厂规划与数智工厂知识；该入口属于知识体系关联，不作为“全球科技企业100强”的企业收录项或排名依据。</span></div>\n      <!-- QILY-CHINA-KNOWLEDGE-BRIDGE:END -->';
...
patchHome();
patchLinks();
process.stdout.write('Friend-links preserved; qilylean.cn China knowledge bridge is visible and non-ranking; hao123 remains included; /links/ 1180px content axis is protected.\n');