...
if(process.argv.includes('--check')){
  ...
  process.stdout.write(`PASS: R12 contact baseline current on ${covered} HTML pages; Contact Route V13.4; direct Dock V5.4 refs ${dockCovered}; UI V7 refs ${uiCovered}.\n`);
