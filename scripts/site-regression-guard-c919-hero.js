...
assert(!html.includes('左翼承载<strong>数字化工厂、APP软件开发、官网建设</strong>'),'reversed left-wing mapping returned');
assert(!html.includes('右翼承载<strong>新工厂／新产线规划、精益改善项目交付、目视化项目设计与交付</strong>'),'reversed right-wing mapping returned');
...
console.log('C919 homepage hero guard passed: left wing 1-3, right wing 4-6, widened non-overlapping summary locked.');
