...
const image=path.join(root,'qilylean','c919-strategy-hero-v11.png');
...
assert(fs.existsSync(image)&&fs.statSync(image).size>500000,'C919 standalone v11 PNG missing or too small');
assert(html.includes('src="/qilylean/c919-strategy-hero-v11.png"'),'C919 v11 PNG path missing');
...
assert(html.includes('rel="preload" as="image" href="/qilylean/c919-strategy-hero-v11.png" type="image/png"'),'C919 v11 PNG preload missing');
assert(html.includes('content="https://qilylean.com/qilylean/c919-strategy-hero-v11.png"'),'C919 social image must use standalone v11 PNG');
console.log('C919 homepage hero guard passed: standalone v11 PNG is present, referenced and protected from SVG-resource disappearance.');
