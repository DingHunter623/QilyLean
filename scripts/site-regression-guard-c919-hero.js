...
assert(html.includes('助企业高质量发展'),'left strategic axis missing');
assert(html.includes('启力精益展翼远航'),'right strategic axis missing');
...
console.log('C919 homepage hero guard passed.');
