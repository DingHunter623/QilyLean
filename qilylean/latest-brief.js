...
var releaseCandidate={
  date:'2026-08-11',
  theme:'目视化管理与现场闭环',
  title:'目视化不是把信息贴上墙：让状态可见、异常可判、责任可追、行动可闭环',
  summary:'制造现场的目视化不是多做几块看板、贴几张标签，而是把目标、现状、标准、异常、责任、时限与验证证据放到同一信息界面，让任何相关人员都能快速判断“现在是否正常、哪里异常、谁在处理、何时关闭”。',
  href:'/qilylean/daily/2026-08-11.html'
};
