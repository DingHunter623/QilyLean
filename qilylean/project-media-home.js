(function () {
  ...
  function apply() {
    ...
    mountFigure(
      ...
      '<img src="/media/projects/vsm-smed.webp?v=20260807-project-media-restore-v3" alt="汽车电子企业第一阶段精益体系建设" width="1400" height="933" loading="lazy" decoding="async" fetchpriority="low">' +
    ...
    mountFigure(
      ...
      '<img src="/media/projects/300t.webp?v=20260807-project-media-restore-v3" alt="300T冲压机3.5T大型模具SMED快速换模改善项目" width="1194" height="1317" loading="lazy" decoding="async" fetchpriority="low">'
    );
    ...
    mountFigure(
      ...
      '<div class="main"><img src="/media/projects/mold-before.webp?v=20260807-project-media-restore-v3" alt="立体库Layout规划设计" width="1400" height="1008" loading="lazy" decoding="async" fetchpriority="low"><span>立体库Layout规划设计</span></div>' +
      '<div><img src="/media/projects/mold-after1.webp?v=20260807-project-media-restore-v3" alt="立体库雏形" width="900" height="1200" loading="lazy" decoding="async" fetchpriority="low"><span>立体库雏形</span></div>' +
      '<div><img src="/media/projects/mold-after2.webp?v=20260807-project-media-restore-v3" alt="智能立体库操作系统" width="900" height="505" loading="lazy" decoding="async" fetchpriority="low"><span>智能立体库操作系统</span></div>' +
    ...
    mountFigure(
      ...
      '<div><img src="/media/projects/fuse-before.webp?v=20260807-project-media-restore-v3" alt="玻璃管保险丝改善后半成品" width="900" height="494" loading="lazy" decoding="async" fetchpriority="low"><span>改善后半成品</span></div>' +
      '<div><img src="/media/projects/fuse-after.webp?v=20260807-project-media-restore-v3" alt="玻璃管保险丝改善后成品" width="816" height="1200" loading="lazy" decoding="async" fetchpriority="low"><span>改善后成品</span></div>' +
    ...
    mountFigure(
      ...
      '<div class="project-media-grid-2">' +
      '<div><img src="/园区.png?v=20260807-project-media-restore-v3" alt="新工厂与工业园区总体规划鸟瞰效果图" loading="lazy" decoding="async" fetchpriority="low"><span>园区总体规划</span></div>' +
      '<div><img src="/写字楼.png?v=20260807-project-media-restore-v3" alt="新工厂写字楼与园区门户规划效果图" loading="lazy" decoding="async" fetchpriority="low"><span>写字楼与园区门户</span></div>' +
    ...
    mountFigure(
      ...
      '<img src="/media/projects/shuzhihua.webp?v=20260807-project-media-restore-v3" alt="数智化工厂数据地基与制造运营协同" width="1400" height="1120" loading="lazy" decoding="async" fetchpriority="low">' +
