...
function addDailyInsights(){
  ...
  section.innerHTML='<div class="inner"><div class="head"><h2>每日工程版简报</h2><p>围绕精益生产、IE、PMC、ERP/MES、数智化工厂、AI工具、汽车电子与半导体制造，持续发布可用于工作决策、行业观察和个人知识沉淀的工程版内容。</p></div><article class="article"><small>2026-07-24｜横向展开 / 防止复发</small><h2>改善真正形成能力，不是结案，而是把有效做法复制出去</h2><ul class="tag-row"><li>横向展开</li><li>标准化</li><li>防止复发</li><li>知识沉淀</li></ul><p>对策经过实绩验证并固化为标准，只完成了单点闭环；还要识别相似产品、设备、工序和区域，完成风险筛查、标准适配、现场验证与责任固化，才能把一次改善转化为企业可复制的知识。</p><div class="actions"><a class="button" href="/qilylean/daily/2026-07-24.html" target="_top">查看今日简报</a><a class="button secondary" href="/qilylean/daily-insights.html" target="_top">查看简报目录</a><a class="button secondary" href="/qilylean/lean-tools.html" target="_top">进入精益工具库</a></div></article></div>';
