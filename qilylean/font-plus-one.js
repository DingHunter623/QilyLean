(function(){
  ...
  function boot(){
    ...
    load('project-media-home.js?v=20260729-factory-layout-v2','projectMediaHomeScript');
    ...
    load('knowledge-publish-fix-v1.js?v=20260729-today-v2','knowledgePublishFixScript');
  }
